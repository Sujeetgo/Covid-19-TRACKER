...
// list of country in form of code ...
let country_list = [
    { name: 'USA', code: 'US' },
    { name: 'Spain', code: 'ES' },
    { name: 'Italy', code: 'IT' },
...
const searctCountryEl =document.querySelector(".search-country");
const countryListEl =document.querySelector(".country-list");
const changeCountryEl =document.querySelector(".change-country");
...
const showCountryList = ()=>{
    inputEl.value = "";
    resetCountryList();
    searctCountryEl.classList.toggle("hide");
    searctCountryEl.classList.add("fadeIn");
}
changeCountryEl.addEventListener('click', showCountryList);


const hideCountryList = ()=>{
    searctCountryEl.classList.toggle("hide");
    // searctCountryEl.classList.toggle("fadeIn");
}
closeEl.addEventListener("click", hideCountryList);
